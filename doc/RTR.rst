...
This documents describes the requirements of the |library_name| Library.
...
.. req:: Display HTML code
    ...
    The main |library_name| Widget must provide a interface to set HTML code as an string.
...
.. req:: Display Content from URL
    ...
    The main |library_name| Widget must provide a interface to set an URL.
...
.. req:: Current URL provision
    ...
    The main |library_name| must provide the current URL if changed e.g. by following
    a link or an anchor. The current url must be provided by sending an Qt signal.
    The current URL should also provided by the |library_name| main widgets interface.

.. req:: Resource Loading Hierarchy
    :id: R_0006
    :status: implemented

    The main |library_name| Widget must provide an interface to load resources from
...
.. req:: Scrolling
    ...
    The main |library_name| should provide scrollbars to view the complete content.
    The scrollbar handling must be implemented in the main |library_name| Widget.
    
.. req:: Zoom In/Out
    :id: R_0008
    :status: implemented

    The main |library_name| should provide a possiblity to Zoom the content.
    ...
    * <STRG>+0 to undo zoom and set the default (100%) zoom level
    ...
    The zoom is limited, the main |library_name| should provide an interface to set the limits.
